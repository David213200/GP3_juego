...
export default class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('player_handgun_blood', '/public/assets/principal_character/personaje2_sangre.png', { frameWidth: 313, frameHeight: 207 });
    this.load.spritesheet('player_handgun_fogonazo', '/public/assets/principal_character/personaje4_fuego.png', { frameWidth: 313, frameHeight: 207 });
  ...
  playerHitCallback(playerHit, bulletHit) {
    ...
    if (bulletHit.active === true && playerHit.active === true && this.playerHealth > 0) {
      ...
      // Cambiar la textura del jugador a player_handgun_blood durante 1 segundo
      this.player.setTexture('player_handgun_blood');

      // Restaurar la textura original del jugador después de 1 segundo
